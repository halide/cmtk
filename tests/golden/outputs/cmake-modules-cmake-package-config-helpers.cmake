...
function(CONFIGURE_PACKAGE_CONFIG_FILE _inputFile _outputFile)
  ...
  if (CCF_UNPARSED_ARGUMENTS)
    message(
      FATAL_ERROR "Unknown keywords given to CONFIGURE_PACKAGE_CONFIG_FILE(): \"${CCF_UNPARSED_ARGUMENTS}\""
    )
  endif ()
...
function(generate_apple_platform_selection_file _output_file)
  ...
  set(_options)
  set(_single INSTALL_DESTINATION INSTALL_PREFIX ${_config_file_options} ERROR_VARIABLE)
  set(_multi)
  ...
  configure_package_config_file(
    "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/Internal/ApplePlatformSelection.cmake.in" "${_output_file}"
...
function(generate_apple_architecture_selection_file _output_file)
  set(_options)
  set(_single INSTALL_DESTINATION INSTALL_PREFIX UNIVERSAL_INCLUDE_FILE ERROR_VARIABLE)
  set(_multi SINGLE_ARCHITECTURES SINGLE_ARCHITECTURE_INCLUDE_FILES UNIVERSAL_ARCHITECTURES)
  ...
  if (NOT _gasf_SINGLE_ARCHITECTURES_len EQUAL _gasf_SINGLE_ARCHITECTURE_INCLUDE_FILES_len)
    message(
      FATAL_ERROR "SINGLE_ARCHITECTURES and SINGLE_ARCHITECTURE_INCLUDE_FILES do not have the same number of entries."
    )
  endif ()
  ...
  if (_gasf_ERROR_VARIABLE)
    string(APPEND _branch_code "set(\"${_gasf_ERROR_VARIABLE}\" \"\")\n")
  endif ()
  ...
  if (NOT "${_gasf_UNIVERSAL_ARCHITECTURES}" STREQUAL "")
    string(APPEND _branch_code
      "list(REMOVE_ITEM _cmake_apple_archs ${_gasf_UNIVERSAL_ARCHITECTURES})\n"
    )
  endif ()
  string(APPEND _branch_code "\n")
  ...
  if (_gasf_ERROR_VARIABLE)
    ...
    string(APPEND _branch_code "${_indent}message(FATAL_ERROR \"Architecture not supported\")\n")
  endif ()
  if (maybe_else)
  ...
  configure_package_config_file(
    "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/Internal/AppleArchitectureSelection.cmake.in"
    "${_output_file}"
