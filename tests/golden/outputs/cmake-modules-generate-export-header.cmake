...
macro(_check_cxx_compiler_attribute _ATTRIBUTE _RESULT)
  check_source_compiles(
    CXX "${_ATTRIBUTE} int somefunc() { return 0; }
...
macro(_check_c_compiler_attribute _ATTRIBUTE _RESULT)
  check_source_compiles(
    C "${_ATTRIBUTE} int somefunc(void) { return 0; }
...
macro(_test_compiler_hidden_visibility)
  ...
  if (CMAKE_CXX_COMPILER_ID STREQUAL "GNU" AND CMAKE_CXX_COMPILER_VERSION VERSION_LESS "4.2")
    set(GCC_TOO_OLD TRUE)
  elseif (CMAKE_C_COMPILER_ID STREQUAL "GNU" AND CMAKE_C_COMPILER_VERSION VERSION_LESS "4.2")
    set(GCC_TOO_OLD TRUE)
  ...
  if (
    ...
    if (CMAKE_CXX_COMPILER_LOADED)
      ...
      check_compiler_flag(CXX -fvisibility-inlines-hidden COMPILER_HAS_HIDDEN_INLINE_VISIBILITY)
    else ()
      check_compiler_flag(C -fvisibility=hidden COMPILER_HAS_HIDDEN_VISIBILITY)
      check_compiler_flag(C -fvisibility-inlines-hidden COMPILER_HAS_HIDDEN_INLINE_VISIBILITY)
    endif ()
  endif ()
endmacro()
...
macro(_test_compiler_has_deprecated)
  ...
  if (
    CMAKE_CXX_COMPILER_ID MATCHES Borland
    ...
    if (CMAKE_CXX_COMPILER_LOADED)
      ...
      _check_c_compiler_attribute("__attribute__((__deprecated__))" COMPILER_HAS_DEPRECATED_ATTR)
      if (COMPILER_HAS_DEPRECATED_ATTR)
        set(COMPILER_HAS_DEPRECATED "${COMPILER_HAS_DEPRECATED_ATTR}"
          CACHE INTERNAL "Compiler support for a deprecated attribute"
        )
      else ()
        _check_c_compiler_attribute("__declspec(deprecated)" COMPILER_HAS_DEPRECATED)
      endif ()
...
function(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  set(oneValueArgs
    PREFIX_NAME BASE_NAME EXPORT_MACRO_NAME EXPORT_FILE_NAME DEPRECATED_MACRO_NAME
    NO_EXPORT_MACRO_NAME STATIC_DEFINE NO_DEPRECATED_MACRO_NAME CUSTOM_CONTENT_FROM_VARIABLE
    INCLUDE_GUARD_NAME
  )
  set(multiValueArgs)
  ...
  if (_GEH_UNPARSED_ARGUMENTS)
    message(
      FATAL_ERROR "Unknown keywords given to generate_export_header(): \"${_GEH_UNPARSED_ARGUMENTS}\""
    )
  endif ()
  ...
  configure_file(
    "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/exportheader.cmake.in" "${EXPORT_FILE_NAME}" @ONLY
  )
endfunction()
...
function(GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  get_property(type TARGET ${TARGET_LIBRARY} PROPERTY TYPE)
  if (
    NOT ${type} STREQUAL "STATIC_LIBRARY"
...
function(add_compiler_export_flags)
  if (NOT CMAKE_MINIMUM_REQUIRED_VERSION VERSION_LESS 2.8.12)
    message(
      DEPRECATION "The add_compiler_export_flags function is obsolete. Use the CXX_VISIBILITY_PRESET and VISIBILITY_INLINES_HIDDEN target properties instead."
    )
  endif ()
